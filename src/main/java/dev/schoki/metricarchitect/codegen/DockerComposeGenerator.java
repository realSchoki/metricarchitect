...
public class DockerComposeGenerator {
	public void generate(IPath targetDir, IProgressMonitor monitor) throws IOException, URISyntaxException {
		String code = DockerComposeGeneratorTemplate.generate();
